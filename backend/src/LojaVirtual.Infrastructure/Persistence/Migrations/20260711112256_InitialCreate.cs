        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nif = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeriesCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    SequenceNumber = table.Column<int>(type: "integer", nullable: false),
                    OrderId = table.Column<Guid>(type: "uuid", nullable: false),
                    SellerName = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    SellerNif = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    CustomerName = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    CustomerNif = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    ...
                    VatAmount = table.Column<decimal>(type: "numeric(14,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_SeriesCode_SequenceNumber",
                table: "Invoices",
                columns: new[] { "SeriesCode", "SequenceNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceSeries_Code",
                table: "InvoiceSeries",
                column: "Code",
                unique: true);
